...
int dag_parse_node_filelist(struct lexer_book *bk, struct dag_node *n);
int dag_parse_node_command(struct lexer_book *bk, struct dag_node *n);
int dag_parse_node_regular_command(struct lexer_book *bk, struct dag_node *n);
int dag_parse_node_nested_makeflow(struct lexer_book *bk, struct dag_node *n);
int dag_parse_export(struct lexer_book *bk);
...
{
	struct lexer_book *bk = lexer_init_book(STREAM, stream, 1, 1);
...
void dag_parse_drop_spaces(struct lexer_book *bk)
{
	struct token *t;
