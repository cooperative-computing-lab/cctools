...
static void display_progress(struct work_queue *q)
{
	...
	printf("%6ds | %4d %4d %4d | %6d %4d %4d %4d | %6d %6.02lf %6.02lf %8.02lf | %.02lf\n", (int) (time(0) - start_time), info.workers_init, info.workers_ready, info.workers_busy, global_count, info.tasks_waiting, info.tasks_running,
	       info.tasks_complete, tasks_done, (tasks_runtime / 1000000.0) / tasks_done, (tasks_filetime / 1000000.0) / tasks_done, (tasks_runtime / 1000000.0) / (tasks_filetime / 1000000.0), speedup);
