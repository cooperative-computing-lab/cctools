...
struct batch_queue_module {
	...
	struct {
		batch_job_id_t (*submit) (struct batch_queue *Q, const char *command, const char *inputs, const char *outputs, const char *error, struct jx *env_list, const struct rmsummary *resources);
