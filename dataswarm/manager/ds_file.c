...
{
	switch(state) {
        case DS_FILE_PENDING: return "pending";
        case DS_FILE_ALLOCATING: return "allocating";
        case DS_FILE_MUTABLE: return "mutable";
        case DS_FILE_COMMITTING: return "committing";
        case DS_FILE_IMMUTABLE: return "immutable";
        case DS_FILE_DELETING: return "deleting";
        case DS_FILE_DELETED: return "deleted";
