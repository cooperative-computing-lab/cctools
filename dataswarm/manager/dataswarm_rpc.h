...
ds_result_t dataswarm_rpc_blob_result( struct dataswarm_manager *m, struct ds_worker_rep *r, jx_int_t msg_id );

void dataswarm_rpc_blob_dispatch( struct dataswarm_manager *m, struct ds_worker_rep *r);
ds_result_t dataswarm_rpc_get_response( struct dataswarm_manager *m, struct ds_worker_rep *w);
