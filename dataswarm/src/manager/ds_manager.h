...
*/
void ds_specify_task_order(struct ds_manager *m, int order);
...
*/
void ds_specify_manager_mode(struct ds_manager *m, int mode);
...
*/
void ds_specify_estimate_capacity_on(struct ds_manager *m, int estimate_capacity_on);
