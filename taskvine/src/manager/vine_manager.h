...
struct vine_manager {
	...
	int enforce_worker_eviction_interval;   /* Used in experimental mode to enforce worker eviction interval in seconds */
	int max_workers;                        /* Used in experimental mode to limit the number of workers */
};
