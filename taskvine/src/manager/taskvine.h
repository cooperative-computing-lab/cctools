...
typedef enum {
	VINE_PEER_NOSHARE = 0,    /**< Do not schedule this file to be shared between peers. (default) */
	VINE_PEER_SHARE = 1       /**< Schedule this file to be shared between peers where available. */
	/*
