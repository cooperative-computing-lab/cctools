...
struct vine_file {
	...
	vine_file_transfer_flags_t t_flags; // whether or not to transfer this file between workers.
};

struct vine_file * vine_file_create( const char *source, const char *cached_name, const char *data, size_t size, vine_file_t type, struct vine_task *mini_task, vine_file_transfer_flags_t t_flags);
