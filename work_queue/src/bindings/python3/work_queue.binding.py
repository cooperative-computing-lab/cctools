...
=======
    ##
    # Maps a function to elements in array using work_queue
    #
    ...
    ##
    # Returns the values for a function of each pair from 2 arrays
    # 
    # The pairs that are passed into the function are generated by itertools
    #
    # @param self       Reference to the current work queue object.
    # @param fn         The function that will be called on each element
    # @param array1     The first array that will be used to generate pairs
    ...
    ##
    # Reduces an array until only one value is left, and then returns that value
    # The array is reduced by passing a pair of elements into a fucntion and then stores the result
    # It then makes an array from the results, and reduces again until one value is left. 
    # 
    # If the array has an odd length, the last element gets reduced at the end
    #
    # @param self       Reference to the current work queue object.
    # @param fn         The function that will be called on each element
    ...
    def Nmap(self, fn, array, chunk_size=1):
        results = [None] * math.ceil(len(array)/chunk_size)
        tasks = {}
