...
LIST_ITEM MANPAGE(work_queue_worker,1), MANPAGE(work_queue_status,1), MANPAGE(work_queue_pool,1), MANPAGE(condor_submit_workers,1), MANPAGE(sge_submit_workers,1), MANPAGE(torque_submit_workers,1), MANPAGE(ec2_submit_workers,1), MANPAGE(ec2_remove_workers,1)
LIST_END')dnl
dnl
